...
class Member(MemberType):
    ...
    def __init__(self, id: int,
        ...
        self.groups = groups
        self.permissions = permissions if permissions else {ServerPermissions: {}, ChannelPermissions: {}}
    ...
    async def get_permissions(self,) -> dict[
        ...
        if Member.database:
            ...
            for x in channel_perms:
                permissions["channel"][x["channel_id"]] = ChannelPermissions(["permissions"])
            ...
            for x in server_perms:
                permissions["server"][x["server_id"]] = ServerPermissions(['permissions'])
